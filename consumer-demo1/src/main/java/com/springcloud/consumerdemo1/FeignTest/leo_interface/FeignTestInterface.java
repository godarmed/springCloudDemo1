...
import com.springcloud.consumerdemo1.FeignTest.hystrix.FeignClientFallback;
...
@Service
@FeignClient(name = "provider-8783", configuration = FileFeignConfig.class, fallback = FeignClientFallback.class)
