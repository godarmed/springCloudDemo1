...
public final class ExcelUtil {
     ...
     */
    public static <T extends BaseRowModel> List<T> readExcel(final InputStream inputStream, final Class<? extends BaseRowModel> clazz,Integer lineNum) {
        if (null == inputStream) {
        ...
        reader.read(new Sheet(1, lineNum, clazz));
